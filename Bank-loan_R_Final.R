...
boxplot(df$employ, col="blue")

boxplot(df$address, col="blue")

boxplot(df$income, col="blue")

boxplot(df$debtinc, col="blue")

boxplot(df$creddebt, col="blue")

boxplot(df$othdebt, col="blue")
...
# Even after tuning we get the maximum accuracy.
...
# We have high accuracy with cutoff 0.4795718.
